...
هذه المهارة توفر إطار عمل منهجي لتحليل وتحسين أداء التطبيقات عبر خمسة محاور رئيسية:
1. **Bundle Size Analysis** - تحليل حجم الحزم
2. **Bottleneck Detection** - كشف الاختناقات
3. **Caching Strategy** - استراتيجيات التخزين المؤقت
4. **Logging Best Practices** - أفضل ممارسات السجلات
5. **Observability Setup** - إعداد المراقبة والرصد
...
| المجال | الأولوية | الأدوات الرئيسية |
|--------|----------|------------------|
| Bundle Size | 🔴 عالية | Bundle analyzer, tree shaking |
| Bottlenecks | 🔴 عالية | DevTools Profiler, Performance API |
| Caching | 🟡 متوسطة | Redis, SWR, HTTP headers |
| Logging | 🟡 متوسطة | pino, structured logging |
| Observability | 🟢 مستمرة | OpenTelemetry, Prometheus, Grafana |

**القاعدة الذهبية**: قس أولاً، ثم حسّن، ثم تحقق من النتائج. لا تحسّن بدون قياس.
