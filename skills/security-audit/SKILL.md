...
هذه المهارة توفر إطار عمل منهجي للتدقيق الأمني الشامل للتطبيقات، مع التركيز على:
- **فحص المدخلات** (Input Validation & Sanitization)
- **إدارة الأسرار** (Secrets Management)
- **الصلاحيات والجلسات** (Authentication & Authorization)
...
للمعايير التفصيلية والأمثلة، راجع:
- [owasp-checklist.md](owasp-checklist.md) - قائمة OWASP Top 10 الكاملة
- [security-patterns.md](security-patterns.md) - أنماط الأمان الشائعة
- [examples.md](examples.md) - أمثلة عملية للثغرات وحلولها
- [security-report-template.md](security-report-template.md) - قالب تقرير التدقيق
...
5. **Keep It Simple**: البساطة = أمان أفضل
6. **Security by Design**: الأمان من البداية، ليس إضافة لاحقة
7. **Regular Updates**: تحديثات دورية للنظام والمكتبات
8. **Security Training**: تدريب الفريق على الأمان
